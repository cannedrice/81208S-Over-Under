...
void skills() {
    ...
    motionProfile.moveDistance(8, -14, 1, {0.05, 0, 0.01}, {65, 0.1, 0.3, 50}, 1000);
    ...
    motionProfile.moveDistance(20, -90, 1, {0.05, 0, 0.01}, {65, 0.1, 0.3, 50}, 1200);
    toggleRightWing();
    pivotTurn(-16, 9500, 0.5, 750, true, {0.016, 0, 0.02});
    toggleLeftWing();
    motionProfile.moveDistance(3, -16, 1, {0.05, 0, 0.01}, {65, 0.1, 0.3, 50}, 500);
    pivotTurn(26, 9500, 0.5, 750, true, {0.016, 0, 0.02});
    motionProfile.moveDistance(5, 26, 1, {0.05, 0, 0.01}, {65, 0.1, 0.3, 50}, 750);
    pivotTurn(52, 9500, 0.5, 750, true, {0.016, 0, 0.02});
    intake.moveVoltage(-12000);
    motionProfile.moveDistance(12, 52, 1, {0.05, 0, 0.01}, {50, 0.1, 0.3, 40}, 1000);
