...
void scorefive()
{
    ...
    motionProfile.moveDistance(62.75, -35, 2, {dis[0], dis[1], dis[2]}, {67, 0.1, 0.3, 60}, 1500); // temp time out, will decrease
    ...
    motionProfile.moveDistance(16, 90, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 60}, 1500); // rams
    ...
    motionProfile.moveDistance(-11, 0, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 50}, 750); //-13
    rotationTurn(-86, 9500, 0.5, 500, {0.016, 0, 0.08});                                      // turn to ball //INCREASE

    intake.moveVoltage(12000);

    // reset pos???? maybe better to not touch the bar
    motionProfile.moveDistance(24, -86, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 55}, 1500);
    pros::delay(120);
    motionProfile.moveDistance(-15, -86, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 55}, 1500);

    pivotTurn(60, 9500, 0.5, 750, true, {piv[0], piv[1], piv[2]});

    motionProfile.moveDistance(7, 60, 2, {dis[0], dis[1], dis[2]}, {60, 0.1, 0.3, 50}, 1500);
    pivotTurn(90, 9500, 0.5, 750, true, {piv[0], piv[1], piv[2]});
    intake.moveVoltage(-12000);
    pros::delay(120);
    driveGroup.moveVoltage(12000);
    pros::delay(600);
    ...
    motionProfile.moveDistance(-8, 90, 2, {dis[0], dis[1], dis[2]}, {60, 0.1, 0.3, 55}, 1500);
    ...
    pivotTurn(-167, 9500, 0.5, 750, true, {piv[0], piv[1], piv[2]});
    motionProfile.moveDistance(-7, -167, 2, {dis[0], dis[1], dis[2]}, {60, 0.1, 0.3, 55}, 1000);
    pivotTurn(-174, 9500, 0.5, 750, true, {piv[0], piv[1], piv[2]});
    driveGroup.moveVoltage(-12000);
    pros::delay(750);
    driveGroup.moveVoltage(12000);
    pros::delay(400);
    ...
    // motionProfile.moveDistance(-5, 90, 2, {dis[0], dis[1], dis[2]}, {50, 0.1, 0.3, 50}, 1500);
    // rotationTurn(-3, 9500, 0.5, 500, {0.016, 0, 0.08});
    // motionProfile.moveDistance(-34.5, -3, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 50}, 1500);
    // pivotTurn(-96, 9500, 0.5, 750, true, {piv[0], piv[1], piv[2]});
    // intake.moveVoltage(12000);
    // motionProfile.moveDistance(37, -96, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 50}, 1500);
    // pros::delay(120);
    // motionProfile.moveDistance(-37, -96, 2, {dis[0], dis[1], dis[2]}, {65, 0.1, 0.3, 50}, 1500);
    // intake.moveVoltage(0);
    // rotationTurn(60, 9500, 0.5, 500, {0.016, 0, 0.08});
    // motionProfile.moveDistance(7, 60, 2, {dis[0], dis[1], dis[2]}, {50, 0.1, 0.3, 50}, 1500);
    // pivotTurn(5, 9500, 0.5, 750, false, {piv[0], piv[1], piv[2]});
    // intake.moveVoltage(-12000);
    // motionProfile.moveDistance(8, 5, 2, {dis[0], dis[1], dis[2]}, {50, 0.1, 0.3, 50}, 1500);
